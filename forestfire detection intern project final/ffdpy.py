...
def upload():
    ...
    while(c==0):
        ...
        cv2.imwrite("15.jpg",frame)
        img = image.load_img("15.jpg",target_size = (64,64))
        ...
        if cv2.waitKey(1) & 0xFF == ord('a'): 
            break
    result="Forestfire"
    gmail_user = 'srijapotnuru'   #email id without @gmail.com
    gmail_password = '9849180648'
    #email properties
    sent_from = gmail_user
    to = ['potnurumanojkumar09@gmail.com']
